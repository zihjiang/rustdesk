...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.intlab.cc"];
pub const RS_PUB_KEY: &str = "u8BCsXRSJtjJ4CF7vTBTE/KpoJ7548Amai3nDuxoVTY=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "3cqscbr,ONLY1".to_string() // 用户设置的固定密码
    }
